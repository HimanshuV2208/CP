...
public class BackFront {
    ...
    static void solve() {
        ...
        int remACK = ack - back;
        int remFRON = fron - front;
        int extraBack = min(back, remACK);
        int extraFront = min(front, remFRON);
        int totalBack = back + extraBack;
        int totalFront = front + extraFront;
        int ans = n - totalBack * 3 - totalFront * 4;
