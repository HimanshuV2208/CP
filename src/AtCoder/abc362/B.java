...
public class B {
    ...
    static void solve() {
        int[] a = _inpArr(6);
        long dist1 = (long) (a[0] - a[2]) * (a[0] - a[2]) + (long) (a[1] - a[3]) * (a[1] - a[3]);
        long dist2 = (long) (a[0] - a[4]) * (a[0] - a[4]) + (long) (a[1] - a[5]) * (a[1] - a[5]);
        long dist3 = (long) (a[4] - a[2]) * (a[4] - a[2]) + (long) (a[5] - a[3]) * (a[5] - a[3]);
